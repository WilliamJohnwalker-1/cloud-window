-- Migration v4.10: Fix retail rounding/refund RPC writing orders.updated_at
-- Execute after migrate-v4.9-refund-approval.sql

-- orders table has no updated_at column in current production schema.
-- v4.8 functions set_retail_order_item_prices_atomic/apply_retail_refund_items_atomic
-- attempted to write orders.updated_at and can fail at runtime.
